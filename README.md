...
#### 2.2.2 测试量化后数据
  ...
  <img width="1328" height="835" alt="image" src="https://github.com/user-attachments/assets/23fb30e9-7438-460a-b79a-06783720e01a" />
  可以看到量化前显存占用为3613MiB /  15360MiB
  量化模型耗时: 3.25 秒

## 3. 应用场景
  根据要求进行对应编码实现了逻辑推理模块。
  <img width="865" height="1119" alt="image" src="https://github.com/user-attachments/assets/72c3d0b2-3ce1-4766-a323-46664312b580" />
